...
import type { CreateRequestInput, ListRequestsQuery, RequestStatus } from '@gex/shared'
...
export class RequestsRepository {
  ...
  private where(query: ListRequestsQuery, viewer: AuthenticatedUser): Prisma.RequestWhereInput {
    return {
