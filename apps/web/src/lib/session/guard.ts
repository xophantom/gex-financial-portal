...
import { ACCESS_COOKIE, REFRESH_COOKIE, SESSION_COOKIE_NAMES, sessionCookies } from './cookies'
import { refreshSession } from './refresh'

// Lógica de src/proxy.ts, separada para ser testável. O access token dura 15 min
